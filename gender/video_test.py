...
classification_model_path = '../trained_models/gender_models/simple_CNN.87-0.91.hdf5'
frame_window = 10
x_offset = 30
y_offset = 60
...
while True:
    ...
    for (x,y,w,h) in faces:
        cv2.rectangle(frame, (x - x_offset, y - y_offset), (x + w + x_offset, y + h + y_offset), (255, 0, 0), 2)
        face = frame[(y - y_offset):(y + h + y_offset), (x - x_offset):(x + w + x_offset)]
        try:
